...
namespace MyCourse.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        // Autenticazione utilizzando servizi esterni (es. Facebook)
        public IList<AuthenticationScheme> ExternalLogins { get; set; }

        // Utilizziamo la variabile FullName all'atto della registrazione per recuperane nome e cognome dell'utente  
