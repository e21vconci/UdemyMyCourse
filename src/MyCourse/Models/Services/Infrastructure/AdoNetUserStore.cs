        ...
        IUserConfirmation<ApplicationUser>
    {
        ...
        public async Task<IdentityResult> UpdateAsync(ApplicationUser user, CancellationToken token)
        {
            int affectedRows = await db.CommandAsync($@"UPDATE AspNetUsers SET UserName={user.UserName}, 
                NormalizedUserName={user.NormalizedUserName}, Email={user.Email}, 
                NormalizedEmail={user.NormalizedEmail}, EmailConfirmed={user.EmailConfirmed}, 
                PasswordHash={user.PasswordHash}, SecurityStamp={user.SecurityStamp}, 
                ConcurrencyStamp={user.ConcurrencyStamp}, PhoneNumber={user.PhoneNumber}, 
                PhoneNumberConfirmed={user.PhoneNumberConfirmed}, TwoFactorEnabled={user.TwoFactorEnabled}, 
                LockoutEnd={user.LockoutEnd}, LockoutEnabled={user.LockoutEnabled}, 
