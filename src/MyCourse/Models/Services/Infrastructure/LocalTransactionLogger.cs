...
namespace MyCourse.Models.Services.Infrastructure
{
    public class LocalTransactionLogger : ITransactionLogger
    {
        ...
        private readonly SemaphoreSlim semaphore = new SemaphoreSlim(1); // per gestire la concorrenza multipla. Un solo thread alla volta.
        ...
        // Il servizio è stato aggiunto come singleton e bisogna gestire la concorrenza multipla.
